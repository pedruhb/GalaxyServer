...
namespace Galaxy.HabboHotel.Permissions
{
    public sealed class PermissionManager
    {
        private static readonly ILog log = LogManager.GetLogger("Galaxy.HabboHotel.Permissions.PermissionManager");
        ...
        public void Init()
        {
           ...
           PermissionGroupRights.Clear();
            ...
            log.Info("» PRONTO! " + Permissions.Count + " permissões.");
            log.Info("» PRONTO! " + PermissionGroups.Count + " cargos.");
   //         log.Info("» PRONTO! " + PermissionGroupRights.Count + " direitos dos grupos de licenciamento.");
     //       log.Info("» PRONTO! " + PermissionSubscriptionRights.Count + " licenças com direitos de subscrição.");
        }
