...
namespace Galaxy.HabboHotel.Groups.Forums
{
    public class GroupForumThread
    {
        ...
        {
            GalaxyServer.GetGame().GetClientManager().OnClientDisconnect += GroupForumThread_OnClientDisconnect;
            ...
            DeletedTimestamp = (int)GalaxyServer.GetUnixTimestamp();
        ...
        {
            return GalaxyServer.GetHabboById(UserId);
        }

        public Habbo GetDeleter()
        {
            return GalaxyServer.GetHabboById(DeleterUserId);
        }

        public GroupForumThreadPost CreatePost(int userid, string message)
        {
            var now = (int)GalaxyServer.GetUnixTimestamp();
        ...
        public void SerializeData(GameClient Session, ServerPacket Packet)
        {
            ...
            Packet.WriteInteger((int)(GalaxyServer.GetUnixTimestamp() - Timestamp)); //Created Secs Ago
            ...
            Packet.WriteInteger(!isn ? (int)(GalaxyServer.GetUnixTimestamp() - lastpost.Timestamp) : 0); //Last message timestamp
            ...
            if (deleter != null)
            {
                ...
                Packet.WriteInteger((int)(GalaxyServer.GetUnixTimestamp() - DeletedTimestamp));//deleted secs ago
            }
            else
            {
