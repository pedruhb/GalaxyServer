...
namespace Galaxy.HabboHotel.Catalog.Utilities
{
    public static class ItemUtility
    {
        ...
        public static int GetSaddleId(int Saddle)
        {
            switch (Saddle)
            {
                default:
                case 9:
                    return GalaxyServer.GetGame().GetItemManager().GetItemByName("horse_saddle1").Id;
                case 10:
                    return GalaxyServer.GetGame().GetItemManager().GetItemByName("horse_saddle2").Id;
            }
        }
