...
namespace Galaxy.HabboHotel.Games
{
    public class GameDataManager
    {
        private static readonly ILog log = LogManager.GetLogger("Galaxy.HabboHotel.Games.GameDataManager");
