...
using Galaxy.Communication.Packets.Outgoing.Quests;
...
namespace Galaxy.HabboHotel.Quests
{
    public class QuestManager
    {
        private static readonly ILog log = LogManager.GetLogger("Galaxy.HabboHotel.Quests.QuestManager");
