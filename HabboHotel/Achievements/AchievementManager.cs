...
namespace Galaxy.HabboHotel.Achievements
{
    public class AchievementManager
    {
        private static readonly ILog log = LogManager.GetLogger("Galaxy.HabboHotel.Achievements.AchievementManager");
    ...
    //        log.Info("» Conquistas -> PRONTO!");
        ...
        public void TryProgressLoginAchievements(GameClient Session)
        {
            ...
            Double daysBtwLastLogin = GalaxyServer.GetUnixTimestamp() - Session.GetHabbo().LastOnline;
        ...
        public void TryProgressRegistrationAchievements(GameClient Session)
        {
            ...
            double sinceMember = GalaxyServer.GetUnixTimestamp() - (int)Session.GetHabbo().AccountCreated;
        ...
        public void TryProgressHabboClubAchievements(GameClient Session)
        {
            ...
            Double SinceActivation = GalaxyServer.GetUnixTimestamp() - Subscription.ExpireTime;
        ...
        public bool ProgressAchievement(GameClient Session, string AchievementGroup, int ProgressAmount, bool FromZero = false)
        {
            ...
            if (AchievementGroup == "ACH_FootballGoalScored")
            {
                Room PHB = null;
                if (GalaxyServer.GetGame().GetRoomManager().TryGetRoom(Session.GetHabbo().CurrentRoomId, out PHB))
                    PHB.GetWired().TriggerEvent(HabboHotel.Items.Wired.WiredBoxType.TriggerSpaceFazGol, Session.GetHabbo()); /// WIRED
            }
