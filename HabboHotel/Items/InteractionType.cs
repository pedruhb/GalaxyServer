    ...
    public class InteractionTypes
    {
        public static InteractionType GetTypeFromString(string pType)
        {
            switch (pType.ToLower())
            {
				...
				/// totem & botem
				case "planetatotem":
					return InteractionType.PlanetaTotem;
				case "planetabotem":
					return InteractionType.PlanetaBotem;

				case "corpototem":
					return InteractionType.CorpoTotem;
				case "corpobotem":
					return InteractionType.CorpoBotem;

				case "cabecatotem":
					return InteractionType.CabecaTotem;
				case "cabecabotem":
					return InteractionType.CabecaBotem;
				////
				...
				case "club_vip3":
					return InteractionType.CLUB_VIP3;
				case "roller":
                ...
                case "televisao":
                    return InteractionType.TELEVISAO;
                case "loteria":
                    return InteractionType.LOTERIA;
				...
				case "club_expert":
					return InteractionType.CLUB_EXPERT;
				case "club_expert2":
					return InteractionType.CLUB_EXPERT2;
				case "varinha":
					return InteractionType.VARINHA;
