...
namespace Galaxy.HabboHotel.Items.Wired.Boxes.Effects
{
    class SetFreezeUserBox : IWiredItem
    {
        ...
        public bool Execute(params object[] Params)
        {
			...
			Player.GetClient().SendMessage(RoomNotificationComposer.SendBubble("wffrozen", "Você foi congelado por 10 segundos!", ""));
			Player.GetClient().GetHabbo().WiredCongelar = GalaxyServer.GetIUnixTimestamp() + 10;
