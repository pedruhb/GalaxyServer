...
namespace Galaxy.HabboHotel.Rooms.Chat.Commands.Comandos
{
    class MutePetsCommand : IChatCommand
    {
        ...
        public string Description => "Ignorar ou permitir bate papo de pets";
        ...
        public void Execute(GameClients.GameClient Session, Rooms.Room Room, string[] Params)
        {
            ...
            if (Session.GetHabbo().AllowPetSpeech)
                Session.SendWhisper("Mudança bem sucedida, agora você não pode mensagens de pets.");
            else
                Session.SendWhisper("Mudança bem sucedida, agora você ver mensagens de pets.");
        }
    }
}
