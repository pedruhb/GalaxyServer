...
namespace Galaxy.HabboHotel.Rooms.Chat.Commands.Comandos
{
    class FacelessCommand :IChatCommand
    {
        ...
        public void Execute(GameClients.GameClient Session, Rooms.Room Room, string[] Params)
        {
            ...
            Session.GetHabbo().Look = GalaxyServer.GetGame().GetFigureManager().ProcessFigure(Session.GetHabbo().Look, Session.GetHabbo().Gender, Session.GetHabbo().GetClothing().GetClothingParts, true);
