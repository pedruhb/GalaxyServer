...
namespace Galaxy.HabboHotel.Rooms.Chat.Styles
{
    public sealed class ChatStyleManager
    {
        private static readonly ILog log = LogManager.GetLogger("Galaxy.HabboHotel.Rooms.Chat.Styles.ChatStyleManager");
