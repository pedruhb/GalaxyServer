...
using Galaxy.HabboHotel.Items.Wired.Boxes.Add_ons;
using Galaxy.HabboHotel.Items.Wired.Boxes.Conditions;
using Galaxy.HabboHotel.Items.Wired.Boxes.Effects;
using Galaxy.HabboHotel.Items.Wired.Boxes.Triggers;
using System;
...
namespace Galaxy.HabboHotel.Rooms.Instance
{
        ...
        public IWiredItem GenerateNewBox(Item Item)
        {
            switch (Item.GetBaseItem().WiredType)
            {
                ...
                case WiredBoxType.EffectMoveFurniFromNearestUser:
                    return new MoveFurniFromUserBox(_room, Item);*/
                ...
                case WiredBoxType.EffectSendToRoomUserBox:
                    return new SendToRoomUserBox(_room, Item); /// wired de teletransportar pro quarto
                case WiredBoxType.ConditionSpaceHasDiamonds: /// diamantes
                    return new SpaceHasDiamonds(_room, Item);
                case WiredBoxType.ConditionSpaceHasCredits: // moedas
                    return new SpaceHasCredits(_room, Item);
                case WiredBoxType.ConditionSpaceHasMeteoritos: /// gotw
                    return new SpaceHasMeteoritos(_room, Item);
                case WiredBoxType.ConditionSpaceHasDuckets: /// duckets
                    return new SpaceHasDuckets(_room, Item);
                /// moedas negativos
                case WiredBoxType.ConditionSpaceNoHasDiamonds: /// diamantes
                    return new SpaceNoHasDiamonds(_room, Item);
                case WiredBoxType.ConditionSpaceNoHasCredits: // moedas
                    return new SpaceNoHasCredits(_room, Item);
                case WiredBoxType.ConditionSpaceNoHasMeteoritos: /// gotw
                    return new SpaceNoHasMeteoritos(_room, Item);
                case WiredBoxType.ConditionSpaceNoHasDuckets: /// duckets
                    return new SpaceNoHasDuckets(_room, Item);
                /// ranks
                case WiredBoxType.ConditionSpaceHasRank: /// positivo
                    return new SpaceHasRank(_room, Item);
                case WiredBoxType.ConditionSpaceNoHasRank: /// negativo
                    return new SpaceNoHasRank(_room, Item);
                case WiredBoxType.EffectCloseDice:
                    return new CloseDiceBox(_room, Item);
                case WiredBoxType.EffectGiveFurni:
                    return new GiveFurniBox(_room, Item);
