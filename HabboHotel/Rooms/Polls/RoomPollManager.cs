...
namespace Galaxy.HabboHotel.Rooms.Polls
{
    public class PollManager
    {
        private static readonly ILog log = LogManager.GetLogger("Galaxy.HabboHotel.Polls.PollManager");
        ...
        public void Init()
        {
            ...
            using (IQueryAdapter dbClient = GalaxyServer.GetDatabaseManager().GetQueryReactor())
            {
                ...
                log.Info("Carregado " + PollsLoaded + " polls e " + QuestionsLoaded + " questões");
            }
        }
