    ...
    public class RoomUser
    {
        ...
        public string GetUsername()
        {
            ...
            if (GetClient() != null)
            {
                if (GetClient().GetHabbo() != null)
                {
                    ...
                    return GalaxyServer.GetUsernameById(HabboId);
        ...
        public bool IncrementAndCheckFlood(out int MuteTime)
        {
            ...
            else if (ChatSpamCount >= 6)
            {
                ...
                GetClient().GetHabbo().FloodTime = GalaxyServer.GetUnixTimestamp() + MuteTime;
        ...
        public void OnChat(int Colour, string Message, bool Shout)
        {
            ...
            if (Shout)
                Packet = new ShoutComposer(VirtualId, ColouredMessage, GalaxyServer.GetGame().GetChatManager().GetEmotions().GetEmotionsForText(Message), Colour);
            else
                Packet = new ChatComposer(VirtualId, ColouredMessage, GalaxyServer.GetGame().GetChatManager().GetEmotions().GetEmotionsForText(Message), Colour);
            ...
            if (GetClient().GetHabbo().TentId > 0)
            {
                ...
                List<RoomUser> ToNotify = mRoom.GetRoomUserManager().GetRoomUserByRank(17);
            ...
            else
            {
                foreach (RoomUser User in mRoom.GetRoomUserManager().GetUserList().ToList())
                {
					...
					try
					{
						...
						Console.WriteLine("------");
						Console.WriteLine("Erro RoomUser.cs:440");
        ...
        public void SendNameColourPacket()
        {
            ...
            if (GetClient().GetHabbo()._NamePrefix == "off" || GetClient().GetHabbo()._NamePrefix == "")
            {
                ...
                if (GetClient().GetHabbo().chatHTMLColour != "rainbow")
                    Username = "<font color='" + GetClient().GetHabbo().chatHTMLColour + "'>" + GetClient().GetHabbo().Username + "</font>";

                if (GetClient().GetHabbo().chatHTMLColour == "rainbow")
                    Username = "<font color='" + GalaxyServer.RainbowT() + "'>"+ GetClient().GetHabbo().Username + "</font>";

                if (GetClient().GetHabbo().chatHTMLColour == "")
                    Username =  GetClient().GetHabbo().Username;
            ...
            else
            {
                ...
                if (GetClient().GetHabbo()._NamePrefixColor == "rainbow" && GetClient().GetHabbo().chatHTMLColour != "rainbow")
                {
                    Username = "<font color='" + GalaxyServer.RainbowT() + "'>[" + GetClient().GetHabbo()._NamePrefix + "]</font> <font color='" + GetClient().GetHabbo().chatHTMLColour + "'>" + GetClient().GetHabbo().Username + "</font>";
                }
                else if (GetClient().GetHabbo()._NamePrefixColor == "rainbow" && GetClient().GetHabbo().chatHTMLColour == "rainbow")
                {
                    Username = "<font color='" + GalaxyServer.RainbowT() + "'>[" + GetClient().GetHabbo()._NamePrefix + "]</font> <font color='" + GalaxyServer.Rainbow() + "'>" + GetClient().GetHabbo().Username + "</font>";
                }
                else if (GetClient().GetHabbo()._NamePrefixColor != "rainbow" && GetClient().GetHabbo().chatHTMLColour == "rainbow")
                {
                    Username = "<font color='" + GetClient().GetHabbo()._NamePrefixColor + "'>[" + GetClient().GetHabbo()._NamePrefix + "]</font> <font color='" + GalaxyServer.Rainbow() + "'>" + GetClient().GetHabbo().Username + "</font>";
                }
                else
                {
        ...
        public bool UserOnBall { get; internal set; }
        ...
        public GameClient GetClient()
        {
            ...
            if (mClient == null)
                mClient = GalaxyServer.GetGame().GetClientManager().GetClientByUserID(HabboId);
            return mClient;
        }
        ...
        {
            if (mRoom == null)
                if (GalaxyServer.GetGame().GetRoomManager().TryGetRoom(RoomId, out mRoom))
                    return mRoom;
