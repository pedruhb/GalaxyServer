...
using Galaxy.HabboHotel.Rewards.Rooms.AI.Types;
using Galaxy.HabboHotel.Rooms.AI.Speech;
using Galaxy.HabboHotel.Rooms.AI.Types;
...
namespace Galaxy.HabboHotel.Rooms.AI
{
    public class RoomBot
    {
        ...
        public RandomSpeech GetRandomSpeech()
        {
            ...
            return RandomSpeech[GalaxyServer.GetRandomNumber(0, (RandomSpeech.Count - 1))];
        }
        #endregion
