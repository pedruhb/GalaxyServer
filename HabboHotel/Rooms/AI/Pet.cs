...
namespace Galaxy.HabboHotel.Rooms.AI
{
    public class Pet
    {
        public int PetId;
        ...
        public void Addexperience(int Amount)
        {
            ...
            if (Room != null)
            {
                ...
                if (experience >= experienceGoal)
                    Room.SendMessage(new ChatComposer(VirtualId, "*subiu de nível para " + Level + " *", 0, 0));
            }
        }
        ...
        public void PetEnergy(bool Add)
        {
            ...
            int r = GalaxyServer.GetRandomNumber(4, MaxE);
        ...
        public Room Room
        {
            get
            {
                ...
                if (GalaxyServer.GetGame().GetRoomManager().TryGetRoom(RoomId, out _room))
                    return _room;
                else
                    return null;
        ...
        public int Age
        {
            get { return Convert.ToInt32(Math.Floor((GalaxyServer.GetUnixTimestamp() - CreationStamp) / 86400)); }
        }
        ...
        {
            get { return GalaxyServer.GetGame().GetClientManager().GetNameById(OwnerId); }
        }
    }
