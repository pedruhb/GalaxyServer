...
namespace Galaxy.HabboHotel.Rooms.AI.Types
{
    class BartenderBot : BotAI
    {
        ...
        public override void OnUserSay(RoomUser User, string Message)
        {
            ...
            BotResponse Response = GalaxyServer.GetGame().GetBotManager().GetResponse(GetBotData().AiType, Message);
            if (Response == null)
                return;
        ...
        public override void OnTimerTick()
        {
            ...
            if (SpeechTimer <= 0)
            {
                if (GetBotData().RandomSpeech.Count > 0)
                {
                    ...
                    GetRoomUser().Chat(String.Replace("%dolar%", GalaxyServer.CotacaoDolar), false, GetBotData().ChatBubble);
                }
