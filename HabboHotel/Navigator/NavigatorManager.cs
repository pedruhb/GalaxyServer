...
namespace Galaxy.HabboHotel.Navigator
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger("Galaxy.HabboHotel.Navigator.NavigatorManager");
        ...
        public void Init()
        {
            ...
            using (IQueryAdapter dbClient = GalaxyServer.GetDatabaseManager().GetQueryReactor())
            {
                ...
                dbClient.SetQuery("SELECT `room_id`,`image` FROM `navigator_staff_picks` ORDER BY id");
       ...
       //     log.Info("» Navegador de salas -> PRONTO!");
        }
