using Galaxy.Core.FigureData.Legacy;
using System;
...
namespace Galaxy.Core.FigureDataManager
{
    public class LegacyFigureMutant
    {
        ...
        public void Init()
        {
            ...
            try
            {
                XDocument Doc = XDocument.Load(Path.Combine(Application.StartupPath, @"config/figuredata.xml"));
