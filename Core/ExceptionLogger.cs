...
namespace Galaxy.Core
{
    public static class ExceptionLogger
    {
        ...
        {
            WriteToFile(@"Logs\errors\MySQL_errors.log", "Erro ao executar: (" + DateTime.Now.ToString("HH:mm:ss") + ")\r\n" + query + "\r\n" + exception + "\r\n\r\n");
        }

        public static void LogException(Exception exception)
        {
            WriteToFile(@"Logs\errors\Exception_errors.log", "Excecao: (" + DateTime.Now.ToString("HH:mm:ss") + ")\r\n" + exception + "\r\n\r\n");
        }

        public static void LogCriticalException(Exception exception)
        {
            WriteToFile(@"Logs\errors\Critical_errors.log", "Excecao: (" + DateTime.Now.ToString("HH:mm:ss") + ")\r\n" + exception + "\r\n\r\n");
        }

        public static void LogThreadException(Exception exception)
        {
            WriteToFile(@"Logs\errors\Thread_errors.log", "Excecao de thread: (" + DateTime.Now.ToString("HH:mm:ss") + ")\r\n" + exception + "\r\n\r\n");
        }

        public static void LogWiredException(Exception exception)
        {
            WriteToFile(@"Logs\errors\Wired_errors.log", "Execao de Wired: (" + DateTime.Now.ToString("HH:mm:ss") + ")\r\n" + exception + "\r\n\r\n");
        }
