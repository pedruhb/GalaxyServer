...
namespace Galaxy.Communication.Packets.Outgoing.Messenger
{
	class HabboSearchResultComposer : ServerPacket
    {
            ...
            : base(ServerPacketHeader.HabboSearchResultMessageComposer)
        {
            ...
            {
                bool Online = (GalaxyServer.GetGame().GetClientManager().GetClientByUserID(Friend.UserId) != null);
            ...
            {
                bool Online = (GalaxyServer.GetGame().GetClientManager().GetClientByUserID(OtherUser.UserId) != null);
