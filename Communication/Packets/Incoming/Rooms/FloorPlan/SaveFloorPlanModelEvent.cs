...
namespace Galaxy.Communication.Packets.Incoming.Rooms.FloorPlan
{
    class SaveFloorPlanModelEvent : IPacketEvent
    {
        public void Parse(HabboHotel.GameClients.GameClient Session, ClientPacket Packet)
        {
            ...
            {
                Session.SendMessage(new RoomNotificationComposer("floorplan_editor.error", "errors", "Oops, você inseriu um mapa inválido!"));
                return;
            }
            ...
            {
                Session.SendMessage(new RoomNotificationComposer("floorplan_editor.error", "errors", "Você ultrapassou o limite de pisos!"));
                return;
            }
			*/
            ...
            if (!isValid)
            {
                Session.SendMessage(new RoomNotificationComposer("floorplan_editor.error", "errors", "Oops, você colocou um mapa inválido!"));
                return;
            }
            ...
            GalaxyServer.GetGame().GetRoomManager().ReloadModel(ModelName);
