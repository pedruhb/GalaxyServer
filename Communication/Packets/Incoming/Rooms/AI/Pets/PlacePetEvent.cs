...
namespace Galaxy.Communication.Packets.Incoming.Rooms.AI.Pets
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger("Galaxy.Communication.Packets.Incoming.Rooms.AI.Pets.PlacePetEvent");
        ...
        public void Parse(HabboHotel.GameClients.GameClient Session, ClientPacket Packet)
        {
            ...
            if (Room.GetRoomUserManager().PetCount > Convert.ToInt32(GalaxyServer.GetGame().GetSettingsManager().TryGetValue("room.pets.placement_limit")))
            {
