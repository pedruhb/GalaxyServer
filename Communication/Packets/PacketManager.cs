...
using Galaxy.Communication.Packets.Incoming.Avatar;
using Galaxy.Communication.Packets.Incoming.Catalog;
using Galaxy.Communication.Packets.Incoming.GameCenter;
using Galaxy.Communication.Packets.Incoming.Groups;
using Galaxy.Communication.Packets.Incoming.HabboCamera;
using Galaxy.Communication.Packets.Incoming.Handshake;
using Galaxy.Communication.Packets.Incoming.Help;
using Galaxy.Communication.Packets.Incoming.Help.Helpers;
using Galaxy.Communication.Packets.Incoming.Inventory.Achievements;
using Galaxy.Communication.Packets.Incoming.Inventory.AvatarEffects;
using Galaxy.Communication.Packets.Incoming.Inventory.Badges;
using Galaxy.Communication.Packets.Incoming.Inventory.Bots;
using Galaxy.Communication.Packets.Incoming.Inventory.Furni;
using Galaxy.Communication.Packets.Incoming.Inventory.Pets;
using Galaxy.Communication.Packets.Incoming.Inventory.Purse;
using Galaxy.Communication.Packets.Incoming.Inventory.Trading;
using Galaxy.Communication.Packets.Incoming.LandingView;
using Galaxy.Communication.Packets.Incoming.Marketplace;
using Galaxy.Communication.Packets.Incoming.Messenger;
using Galaxy.Communication.Packets.Incoming.Misc;
using Galaxy.Communication.Packets.Incoming.Moderation;
using Galaxy.Communication.Packets.Incoming.Navigator;
using Galaxy.Communication.Packets.Incoming.Quests;
using Galaxy.Communication.Packets.Incoming.QuickPolls;
using Galaxy.Communication.Packets.Incoming.Quiz;
using Galaxy.Communication.Packets.Incoming.Rooms.Action;
using Galaxy.Communication.Packets.Incoming.Rooms.AI.Bots;
using Galaxy.Communication.Packets.Incoming.Rooms.AI.Pets;
using Galaxy.Communication.Packets.Incoming.Rooms.AI.Pets.Horse;
using Galaxy.Communication.Packets.Incoming.Rooms.Avatar;
using Galaxy.Communication.Packets.Incoming.Rooms.Chat;
using Galaxy.Communication.Packets.Incoming.Rooms.Connection;
using Galaxy.Communication.Packets.Incoming.Rooms.Engine;
using Galaxy.Communication.Packets.Incoming.Rooms.FloorPlan;
using Galaxy.Communication.Packets.Incoming.Rooms.Furni;
using Galaxy.Communication.Packets.Incoming.Rooms.Furni.LoveLocks;
using Galaxy.Communication.Packets.Incoming.Rooms.Furni.Moodlight;
using Galaxy.Communication.Packets.Incoming.Rooms.Furni.RentableSpaces;
using Galaxy.Communication.Packets.Incoming.Rooms.Furni.Stickys;
using Galaxy.Communication.Packets.Incoming.Rooms.Furni.Wired;
using Galaxy.Communication.Packets.Incoming.Rooms.Furni.YouTubeTelevisions;
using Galaxy.Communication.Packets.Incoming.Rooms.Games;
using Galaxy.Communication.Packets.Incoming.Rooms.Nux;
using Galaxy.Communication.Packets.Incoming.Rooms.Polls;
using Galaxy.Communication.Packets.Incoming.Rooms.Settings;
using Galaxy.Communication.Packets.Incoming.Sound;
...
namespace Galaxy.Communication.Packets
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger("Galaxy.Communication.Packets");
        ...
        public void TryExecutePacket(GameClient Session, ClientPacket Packet)
        {
			...
			if (!_incomingPackets.TryGetValue(Packet.Id, out IPacketEvent Pak))
			{
				if (System.Diagnostics.Debugger.IsAttached || ExtraSettings.DEBUG_ENABLED == true)
					log.Debug("Pacote desconhecido: " + Packet.ToString());
				return;
			}
			...
			if (System.Diagnostics.Debugger.IsAttached || ExtraSettings.DEBUG_ENABLED == true)
            {
                if (_packetNames.ContainsKey(Packet.Id))
                    log.Debug("Pacote recebido: [" + Packet.Id + "] " + _packetNames[Packet.Id]);
                else
                    log.Debug("Pacote recebido: [" + Packet.Id + "] Sem Nome");
            }
        ...
        private void ExecutePacketAsync(GameClient Session, ClientPacket Packet, IPacketEvent Pak)
        {
            ...
            catch (AggregateException ex)
            {
                foreach (Exception e in ex.Flatten().InnerExceptions)
                {
                    ...
                    {
                        log.Fatal("Erro de processamento: " + e.Message + " - " + e.StackTrace);
                        Session.Disconnect();
                    }
                }
            }
