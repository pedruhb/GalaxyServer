using Galaxy.Communication.RCON.Commands.Hotel;
using Galaxy.Communication.RCON.Commands.User;
using System;
...
namespace Galaxy.Communication.RCON.Commands
{
    ...
    { 
        ...
        private void RegisterUser()
        {
            ...
            this.Register("aplicarcorestagnome", new AplicarTagCorGalaxyServer());
        ...
        {
            this.Register("reload_extras", new ReloadExtrasCommand());
            ...
            this.Register("reload_permissions", new ReloadPermissionsCommand());
            this.Register("reload_filter", new ReloadFilterCommand());
			this.Register("hotel_alert", new HotelAlertCommand());
			this.Register("staff_alert", new StaffAlertCommand());
			this.Register("rank_alert", new RankAlertCommand());
			this.Register("reloadbadges", new ReloadBadgesPHB());
			this.Register("pontopromo", new PontoPromoAlertPHB());
			this.Register("respondermencao", new ResponderMencao());
			this.Register("novanoticia", new NovaNoticiaAlertaPHB());
			this.Register("desligaremulador", new DesligarEmuladorGalaxyCommand());
            this.Register("reiniciaremulador", new ReiniciarEmuladorGalaxyCommand());
            this.Register("reload_jukebox", new ReloadJukeboxCommand());
            this.Register("reload_lang", new ReloadLangCommand());
			this.Register("atualizarfront", new UpdateFrontPage());
            this.Register("djonline", new AlertaDjOnline());
        }
